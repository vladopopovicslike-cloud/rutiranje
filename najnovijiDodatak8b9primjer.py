...
def spoji_rute (rute_razvozne, rute_povratne, vehicles, osobine1,osobine2, d,osobine3,vreme_rada,tsv, arbajt, mj):
    # `mj` mjerna jedinica za predjeni put: 1 = metri, 1000 = km (proslijediti iz main)
    vr=vreme_rada
