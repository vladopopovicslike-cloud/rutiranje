...
for sheet in instances:
        ...
        for sema in sve_seme:
                ...
                (routes2,skup_povratnih_svih)=najnovijiDodatak8b9primjer.spoji_rute (rute_razvoza_sortirane, rute_povrata, vehicles, osobine,osobine1, dsv,zao, vreme_rada,tsv)
